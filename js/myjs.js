...
function changeLang() {
	...
	if (count == 0) {
		document.getElementById("lang").innerHTML = "ENG" +
			...
			"</g>" +
			'<path style="fill:#E51D35;" d="M280.545,452.432V289.681l46.304,46.307c2.277-13.205,4.069-26.899,5.381-40.896l-8.605-8.605h9.349		c2.337-29.502,2.565-60.047,0.681-89.75h-52.429l47.482-47.482c-2.001-13.455-4.476-26.469-7.434-38.836l-40.728,40.735V21.248C268.103,7.763,253.549,0,236.836,0c-3.938,0-7.872,0.101-11.817,0.292c-11.649,0.583-23.073,2.016-34.225,4.215v191.531L66.808,72.055c-7.618,7.861-14.704,16.237-21.189,25.089l79.313,79.313l20.291,20.284H3.448C1.227,209.784,0,223.164,0,236.844					c0,17.034,1.84,33.626,5.25,49.643h184.834L70.847,405.724c7.808,7.67,16.121,14.813,24.921,21.349l95.023-95.023v137.116					c11.151,2.199,22.583,3.631,34.232,4.215c3.938,0.191,7.872,0.299,11.81,0.299C253.549,473.68,268.103,465.917,280.545,452.432z"/>' +
			"</svg>";
		count = 1;
	} else {
...
//ф-н для отображения поиска
function showSearch() {
	var newForm = document.createElement('form');
	newForm.id = "form_input";
	//	newForm.innerHTML = 'Привет, мир!';
	document.getElementById("search_icon").innerHTML = "";
	search_icon.appendChild(newForm);
	var newInput = document.createElement('input');
	newInput.style.width = "60%";
	newInput.style.height = "30px";
	newInput.style.marginLeft = "8%";
	newInput.style.marginTop = "12px";
	newInput.style.border = "1px solid #5f9ea0";
	newInput.style.borderRadius = "30px";
	newInput.style.paddingLeft = "3%";
	newInput.style.paddingRight = "3%";
	form_input.appendChild(newInput);
	//	document.getElementById("form_input").innerHTML = "<input>";
	//	document.getElementById("search_icon").innerHTML = newForm;
	//	search_icon.insertBefore(newForm, search_icon.children[0]);
}

//ф-н для раскрытия текста? смена символа+-
var s = [],
	s_timer = [];

function show(id1, i1, h, spd) {
	s[id1] = s[id1] == spd ? -spd : spd;
	s_timer[id1] = setTimeout(function () {
		var obj1 = document.getElementById(id1);
		var label1 = document.getElementById(i1);
		if (obj1.offsetHeight + s[id1] >= h) {
			obj1.style.height = h + "px";
			obj1.style.overflow = "auto";
			label1.innerHTML = "Кратко";
		} else if (obj1.offsetHeight + s[id1] <= 290) {
			obj1.style.height = 300 + "px";
			obj1.style.display = "block";
			obj1.style.overflow = "hidden";
			label1.innerHTML = "Подробно";
		} else {
			console.log(obj1.offsetHeight+"+"+s[id1]+"+"+obj1.style.height);
			obj1.style.height = (obj1.offsetHeight + s[id1]) + "px";
			obj1.style.overflow = "hidden";
			obj1.style.display = "block";
